...
export default function WelcomeMessageSection() {
  return (
    <div className="hidden md:flex md:w-1/2  bg-gradient-to-br from-background to-primary-foreground text-primary p-8  flex-col justify-center items-center text-center">    
